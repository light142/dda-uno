from simulator.simulation.bots.noob import NoobBot
from simulator.simulation.bots.casual import CasualBot
from simulator.simulation.bots.pro import ProBot
